      ...
      <div className="space-y-8">
            ...
            <dl className="space-y-4">
              <div>
                <dt className="font-semibold text-gray-900 mb-1">
                  currentPage <span className="text-red-600">*</span>
                </dt>
                <dd className="text-gray-600 text-sm">
                  <code className="bg-gray-100 px-2 py-1 rounded">number</code>{" "}
              ...
              <div>
                <dt className="font-semibold text-gray-900 mb-1">
                  itemsPerPage <span className="text-red-600">*</span>
                </dt>
                <dd className="text-gray-600 text-sm">
                  <code className="bg-gray-100 px-2 py-1 rounded">number</code>{" "}
              ...
              <div>
                <dt className="font-semibold text-gray-900 mb-1">
                  onPageChange <span className="text-red-600">*</span>
                </dt>
                <dd className="text-gray-600 text-sm">
              ...
              <div>
                ...
                <dd className="text-gray-600 text-sm">
                  ...
                  - Show or hide the items per page label (default: true)
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-gray-900 mb-1">className</dt>
                <dd className="text-gray-600 text-sm">
        ...
        <section>
          ...
          <div className="space-y-2">
            <a
              href="http://localhost:6007/?path=/story/ui-pagination--default"
              target="_blank"
